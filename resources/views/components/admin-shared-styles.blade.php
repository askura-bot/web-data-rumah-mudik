...
.t-badge { font-size: .68rem; font-weight: 600; color: var(--accent); background: rgba(245,166,35,.12); border: 1px solid rgba(245,166,35,.25); border-radius: 99px; padding: 3px 10px; white-space: nowrap; }
...
.t-navlink.active { color: #fff; background: rgba(245,166,35,.18); border-color: rgba(245,166,35,.4); }
...
.t-menu { display: none; position: absolute; top: calc(100% + 8px); right: 0; background: #fff; border: 1px solid #e2e6ee; border-radius: 12px; box-shadow: 0 8px 32px rgba(0,0,0,.18); min-width: 210px; overflow: hidden; z-index: 1000; animation: menuDrop .15s ease; }
.t-menu.open { display: block; }
@keyframes menuDrop { from { opacity: 0; transform: translateY(-6px); } to { opacity: 1; transform: translateY(0); } }
.t-menu-item { display: flex; align-items: center; gap: 10px; padding: 10px 14px; text-decoration: none; transition: background .15s; border-bottom: 1px solid #f0f2f6; }
